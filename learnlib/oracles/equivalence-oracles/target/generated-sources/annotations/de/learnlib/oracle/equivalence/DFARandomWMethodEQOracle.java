...
/**
 * A type-specific refinement of {@link RandomWMethodEQOracle}.
 * @param <I> input symbol type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.refinement.RefinementProcessor",
        source = "de.learnlib.oracle.equivalence.RandomWMethodEQOracle"
)
public class DFARandomWMethodEQOracle<I> extends RandomWMethodEQOracle<DFA<?, I>, I, Boolean> implements EquivalenceOracle.DFAEquivalenceOracle<I> {
    /**
     * Delegates to {@link RandomWMethodEQOracle#public void <init>(MembershipOracle, int, int)}.
     ...
     */
    public DFARandomWMethodEQOracle(MembershipOracle.DFAMembershipOracle<I> sulOracle,
            int minimalSize, int rndLength) {
        super(sulOracle, minimalSize, rndLength);
    }

    /**
     * Delegates to {@link RandomWMethodEQOracle#public void <init>(MembershipOracle, int, int, int)}.
     * @param sulOracle maps to the {@code sulOracle} parameter of the delegate
     * @param minimalSize maps to the {@code minimalSize} parameter of the delegate
     * @param rndLength maps to the {@code rndLength} parameter of the delegate
    ...
    /**
     * Delegates to {@link RandomWMethodEQOracle#public void <init>(MembershipOracle, int, int, int, int)}.
     * @param sulOracle maps to the {@code sulOracle} parameter of the delegate
     * @param minimalSize maps to the {@code minimalSize} parameter of the delegate
     * @param rndLength maps to the {@code rndLength} parameter of the delegate
     * @param bound maps to the {@code bound} parameter of the delegate
    ...
    /**
     * Delegates to {@link RandomWMethodEQOracle#public void <init>(MembershipOracle, int, int, int, Random, int)}.
     * @param sulOracle maps to the {@code sulOracle} parameter of the delegate
     * @param minimalSize maps to the {@code minimalSize} parameter of the delegate
     * @param rndLength maps to the {@code rndLength} parameter of the delegate
     * @param bound maps to the {@code bound} parameter of the delegate
