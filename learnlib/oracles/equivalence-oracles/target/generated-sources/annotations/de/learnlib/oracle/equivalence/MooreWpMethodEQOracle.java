...
public class MooreWpMethodEQOracle<I, O> extends WpMethodEQOracle<MooreMachine<?, I, ?, O>, I, Word<O>> implements EquivalenceOracle.MooreEquivalenceOracle<I, O> {
    /**
     ...
     */
    public MooreWpMethodEQOracle(MembershipOracle.MooreMembershipOracle<I, O> sulOracle) {
        super(sulOracle);
    }
