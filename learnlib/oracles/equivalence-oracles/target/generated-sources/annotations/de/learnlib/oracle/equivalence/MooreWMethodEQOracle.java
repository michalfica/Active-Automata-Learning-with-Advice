...
public class MooreWMethodEQOracle<I, O> extends WMethodEQOracle<MooreMachine<?, I, ?, O>, I, Word<O>> implements EquivalenceOracle.MooreEquivalenceOracle<I, O> {
    /**
     ...
     */
    public MooreWMethodEQOracle(MembershipOracle.MooreMembershipOracle<I, O> sulOracle) {
        super(sulOracle);
    }
