...
public class DFAWpMethodEQOracle<I> extends WpMethodEQOracle<DFA<?, I>, I, Boolean> implements EquivalenceOracle.DFAEquivalenceOracle<I> {
    /**
     ...
     */
    public DFAWpMethodEQOracle(MembershipOracle.DFAMembershipOracle<I> sulOracle) {
        super(sulOracle);
    }
     ...
     */
    public DFAWpMethodEQOracle(MembershipOracle.DFAMembershipOracle<I> sulOracle, int lookahead) {
