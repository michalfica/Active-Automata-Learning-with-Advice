...
public class SPASimulatorOracle<I> extends SimulatorOracle<I, Boolean> implements SingleQueryOracle.SingleQueryOracleDFA<I> {
    /**
     ...
     */
    public SPASimulatorOracle(SPA<?, I> automaton) {
        super(automaton);
    }
}
