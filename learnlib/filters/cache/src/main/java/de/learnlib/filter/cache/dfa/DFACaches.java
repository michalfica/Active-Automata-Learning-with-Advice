...
public final class DFACaches {
    ...
    public static <I> DFACacheOracleWithAdviceSystem<I> createCacheWithAdviceSystem(Alphabet<I> alphabet, MembershipOracle<I, Boolean> mqOracle, String SRStype, List<Integer> SRSparameters) {
        return createDAGCacheWithAdviceSystem(alphabet, mqOracle, SRStype, SRSparameters);
    }
    ...
    public static <I> DFACacheOracleWithAdviceSystem<I> createDAGCacheWithAdviceSystem(Alphabet<I> alphabet, MembershipOracle<I, Boolean> mqOracle, String SRStype, List<Integer> SRSparameters) {
        return new DFACacheOracleWithAdviceSystem<>(new IncrementalDFADAGBuilder<>(alphabet), mqOracle, alphabet, SRStype, SRSparameters);
    }
