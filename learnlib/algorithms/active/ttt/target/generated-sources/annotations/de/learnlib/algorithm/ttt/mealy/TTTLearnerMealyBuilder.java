...
/**
 * A builder for constructing {@link TTTLearnerMealy} instances.
 * @param <I> input symbol type
 * @param <O> output symbols type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.builder.BuilderProcessor",
        source = "de.learnlib.algorithm.ttt.mealy.TTTLearnerMealy"
)
public final class TTTLearnerMealyBuilder<I, O> {
    ...
    /**
     * Creates a new {@link TTTLearnerMealy} instance with the configured parameters.
     * @return the created instance
     */
    public TTTLearnerMealy<I, O> create() {
        return new TTTLearnerMealy<I, O>(alphabet, oracle, analyzer);
    }
}
