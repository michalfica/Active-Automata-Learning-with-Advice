...
/**
 * A builder for constructing {@link TTTLearnerMoore} instances.
 * @param <I> input symbol type
 * @param <O> output symbols type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.builder.BuilderProcessor",
        source = "de.learnlib.algorithm.ttt.moore.TTTLearnerMoore"
)
public final class TTTLearnerMooreBuilder<I, O> {
     ...
     */
    public TTTLearnerMooreBuilder<I, O> withAlphabet(Alphabet<I> alphabet) {
        this.alphabet = alphabet;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public TTTLearnerMooreBuilder<I, O> withOracle(MembershipOracle<I, Word<O>> oracle) {
        this.oracle = oracle;
        return this;
    }
    ...
    /**
     * Creates a new {@link TTTLearnerMoore} instance with the configured parameters.
     * @return the created instance
     */
    public TTTLearnerMoore<I, O> create() {
        return new TTTLearnerMoore<I, O>(alphabet, oracle, analyzer);
    }
}
