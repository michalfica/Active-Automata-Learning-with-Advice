...
/**
 * A builder for constructing {@link ExtensibleLStarMealy} instances.
 * @param <I> input symbol type
 * @param <O> output symbol type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.builder.BuilderProcessor",
        source = "de.learnlib.algorithm.lstar.mealy.ExtensibleLStarMealy"
)
public final class ExtensibleLStarMealyBuilder<I, O> {
     ...
     */
    public ExtensibleLStarMealyBuilder<I, O> withAlphabet(Alphabet<I> alphabet) {
        this.alphabet = alphabet;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ExtensibleLStarMealyBuilder<I, O> withOracle(MembershipOracle<I, Word<O>> oracle) {
        this.oracle = oracle;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ExtensibleLStarMealyBuilder<I, O> withInitialPrefixes(List<Word<I>> initialPrefixes) {
        this.initialPrefixes = initialPrefixes;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ExtensibleLStarMealyBuilder<I, O> withInitialSuffixes(List<Word<I>> initialSuffixes) {
        this.initialSuffixes = initialSuffixes;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ExtensibleLStarMealyBuilder<I, O> withCexHandler(
     ...
     * @return the current builder instance
     */
    public ExtensibleLStarMealyBuilder<I, O> withClosingStrategy(
    ...
    /**
     * Creates a new {@link ExtensibleLStarMealy} instance with the configured parameters.
     * @return the created instance
     */
    public ExtensibleLStarMealy<I, O> create() {
        return new ExtensibleLStarMealy<I, O>(alphabet, oracle, initialPrefixes, initialSuffixes, cexHandler, closingStrategy);
    }
}
