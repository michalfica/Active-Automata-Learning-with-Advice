...
/**
 * A builder for constructing {@link MalerPnueliMealy} instances.
 * @param <I> input symbol type
 * @param <O> output symbol type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.builder.BuilderProcessor",
        source = "de.learnlib.algorithm.malerpnueli.MalerPnueliMealy"
)
public final class MalerPnueliMealyBuilder<I, O> {
     ...
     * @return the current builder instance
     */
    public MalerPnueliMealyBuilder<I, O> withClosingStrategy(
    ...
    /**
     * Creates a new {@link MalerPnueliMealy} instance with the configured parameters.
     * @return the created instance
     */
    public MalerPnueliMealy<I, O> create() {
        return new MalerPnueliMealy<I, O>(alphabet, oracle, initialSuffixes, closingStrategy);
    }
}
