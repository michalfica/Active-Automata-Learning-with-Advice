...
/**
 * A builder for constructing {@link RivestSchapireMealy} instances.
 * @param <I> input symbol type
 * @param <O> output symbol type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.builder.BuilderProcessor",
        source = "de.learnlib.algorithm.rivestschapire.RivestSchapireMealy"
)
public final class RivestSchapireMealyBuilder<I, O> {
     ...
     * @return the current builder instance
     */
    public RivestSchapireMealyBuilder<I, O> withOracle(MembershipOracle<I, Word<O>> oracle) {
        this.oracle = oracle;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public RivestSchapireMealyBuilder<I, O> withInitialSuffixes(List<Word<I>> initialSuffixes) {
        this.initialSuffixes = initialSuffixes;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public RivestSchapireMealyBuilder<I, O> withClosingStrategy(
    ...
    /**
     * Creates a new {@link RivestSchapireMealy} instance with the configured parameters.
     * @return the created instance
     */
    public RivestSchapireMealy<I, O> create() {
        return new RivestSchapireMealy<I, O>(alphabet, oracle, initialSuffixes, closingStrategy);
    }
}
