...
/**
 * A builder for constructing {@link MalerPnueliMoore} instances.
 * @param <I> input symbol type
 * @param <O> output symbol type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.builder.BuilderProcessor",
        source = "de.learnlib.algorithm.malerpnueli.MalerPnueliMoore"
)
public final class MalerPnueliMooreBuilder<I, O> {
     ...
     * @return the current builder instance
     */
    public MalerPnueliMooreBuilder<I, O> withOracle(MembershipOracle<I, Word<O>> oracle) {
        this.oracle = oracle;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public MalerPnueliMooreBuilder<I, O> withInitialSuffixes(List<Word<I>> initialSuffixes) {
        this.initialSuffixes = initialSuffixes;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public MalerPnueliMooreBuilder<I, O> withClosingStrategy(
    ...
    /**
     * Creates a new {@link MalerPnueliMoore} instance with the configured parameters.
     * @return the created instance
     */
    public MalerPnueliMoore<I, O> create() {
        return new MalerPnueliMoore<I, O>(alphabet, oracle, initialSuffixes, closingStrategy);
    }
}
