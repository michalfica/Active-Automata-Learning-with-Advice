...
/**
 * A builder for constructing {@link ClassicLStarMealy} instances.
 * @param <I> input symbol type
 * @param <O> output symbol type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.builder.BuilderProcessor",
        source = "de.learnlib.algorithm.lstar.mealy.ClassicLStarMealy"
)
public final class ClassicLStarMealyBuilder<I, O> {
     ...
     */
    public ClassicLStarMealyBuilder<I, O> withAlphabet(Alphabet<I> alphabet) {
        this.alphabet = alphabet;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ClassicLStarMealyBuilder<I, O> withInitialPrefixes(List<Word<I>> initialPrefixes) {
        this.initialPrefixes = initialPrefixes;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ClassicLStarMealyBuilder<I, O> withInitialSuffixes(List<Word<I>> initialSuffixes) {
        this.initialSuffixes = initialSuffixes;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ClassicLStarMealyBuilder<I, O> withCexHandler(
     ...
     * @return the current builder instance
     */
    public ClassicLStarMealyBuilder<I, O> withClosingStrategy(
    ...
    /**
     * Creates a new {@link ClassicLStarMealy} instance with the configured parameters.
     * @return the created instance
     */
    public ClassicLStarMealy<I, O> create() {
        return new ClassicLStarMealy<I, O>(alphabet, oracle, initialPrefixes, initialSuffixes, cexHandler, closingStrategy);
    }
}
