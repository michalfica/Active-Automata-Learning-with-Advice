...
/**
 * A builder for constructing {@link RivestSchapireDFA} instances.
 * @param <I> input symbol type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.builder.BuilderProcessor",
        source = "de.learnlib.algorithm.rivestschapire.RivestSchapireDFA"
)
public final class RivestSchapireDFABuilder<I> {
     ...
     */
    public RivestSchapireDFABuilder<I> withAlphabet(Alphabet<I> alphabet) {
        this.alphabet = alphabet;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public RivestSchapireDFABuilder<I> withInitialSuffixes(List<Word<I>> initialSuffixes) {
        this.initialSuffixes = initialSuffixes;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public RivestSchapireDFABuilder<I> withClosingStrategy(
    ...
    /**
     * Creates a new {@link RivestSchapireDFA} instance with the configured parameters.
     * @return the created instance
     */
    public RivestSchapireDFA<I> create() {
        return new RivestSchapireDFA<I>(alphabet, oracle, initialSuffixes, closingStrategy);
    }
}
