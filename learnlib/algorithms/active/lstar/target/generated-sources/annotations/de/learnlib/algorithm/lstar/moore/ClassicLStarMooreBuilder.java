...
/**
 * A builder for constructing {@link ClassicLStarMoore} instances.
 * @param <I> input symbol type
 * @param <O> output symbol type
 */
@Generated(
        generator = "de.learnlib.tooling.processor.builder.BuilderProcessor",
        source = "de.learnlib.algorithm.lstar.moore.ClassicLStarMoore"
)
public final class ClassicLStarMooreBuilder<I, O> {
    ...
    private ClosingStrategy<? super I, ? super O> closingStrategy;
     ...
     */
    public ClassicLStarMooreBuilder<I, O> withAlphabet(Alphabet<I> alphabet) {
        this.alphabet = alphabet;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ClassicLStarMooreBuilder<I, O> withInitialPrefixes(List<Word<I>> initialPrefixes) {
        this.initialPrefixes = initialPrefixes;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ClassicLStarMooreBuilder<I, O> withInitialSuffixes(List<Word<I>> initialSuffixes) {
        this.initialSuffixes = initialSuffixes;
        return this;
    }
     ...
     * @return the current builder instance
     */
    public ClassicLStarMooreBuilder<I, O> withCexHandler(
     ...
     * @return the current builder instance
     */
    public ClassicLStarMooreBuilder<I, O> withClosingStrategy(
    ...
    /**
     * Creates a new {@link ClassicLStarMoore} instance with the configured parameters.
     * @return the created instance
     */
    public ClassicLStarMoore<I, O> create() {
        return new ClassicLStarMoore<I, O>(alphabet, oracle, initialPrefixes, initialSuffixes, cexHandler, closingStrategy);
    }
}
